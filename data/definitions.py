...
# [NEW] 캐릭터 매칭 데이터 (이미지 + 이유 추가!)
TEMP_IMG = "https://via.placeholder.com/300?text=Image+Coming+Soon"

KIDS_CHARACTERS = {
    "한국 애니메이션": {
        "뽀로로": {"img": TEMP_IMG, "reason": "동글동글한 얼굴형과 호기심 가득한 눈망울이 뽀로로와 똑 닮았어요! 🤓"},
        "루피": {"img": TEMP_IMG, "reason": "부드러운 인상과 귀여운 볼살이 잔망루피를 연상케 하네요! 🌸"},
        "크롱": {"img": TEMP_IMG, "reason": "장난기 넘치는 표정과 활발한 에너지가 크롱과 찰떡입니다! 🦖"},
        "타요": {"img": TEMP_IMG, "reason": "믿음직스럽고 긍정적인 눈빛이 타요와 닮았어요! 🚌"},
        "자두": {"img": TEMP_IMG, "reason": "명랑하고 쾌활한 분위기가 안녕 자두야의 자두 같아요! 🍒"},
        "둘리": {"img": TEMP_IMG, "reason": "개구쟁이 같으면서도 친근한 인상이 둘리를 닮았네요! 🦕"}
    },
    "일본 애니메이션": {
        "루피 (원피스)": {"img": TEMP_IMG, "reason": "시원시원한 미소와 열정적인 눈빛이 해적왕 루피를 닮았어요! 🏴‍☠️"},
        "나루토": {"img": TEMP_IMG, "reason": "장난기 있으면서도 의지가 강해 보이는 눈매가 나루토 같아요! 🍥"},
        "피카츄": {"img": TEMP_IMG, "reason": "귀엽고 사랑스러운 분위기가 피카츄와 싱크로율 100%! ⚡"},
        "토토로": {"img": TEMP_IMG, "reason": "푸근하고 듬직한 인상이 이웃집 토토로를 닮았어요! 🌳"},
        "하울": {"img": TEMP_IMG, "reason": "신비롭고 매력적인 분위기가 하울과 비슷하네요! ✨"},
        "코난": {"img": TEMP_IMG, "reason": "지적이고 예리한 눈빛이 명탐정 코난을 연상시켜요! 👓"}
    },
    "미국 애니메이션": {
        "엘사": {"img": TEMP_IMG, "reason": "우아하고 차분한 분위기가 겨울왕국 엘사를 닮았어요! ❄️"},
        "우디": {"img": TEMP_IMG, "reason": "길쭉한 얼굴형과 선한 인상이 토이스토리 우디와 비슷해요! 🤠"},
        "버즈": {"img": TEMP_IMG, "reason": "강인한 턱선과 자신감 넘치는 표정이 버즈 라이트이어 같아요! 🚀"},
        "미키마우스": {"img": TEMP_IMG, "reason": "밝게 웃는 모습과 긍정적인 에너지가 미키마우스 같아요! 🐭"},
        "심바": {"img": TEMP_IMG, "reason": "당당하고 용맹한 기운이 라이온킹 심바를 닮았네요! 🦁"},
        "라푼젤": {"img": TEMP_IMG, "reason": "호기심 많고 큰 눈망울이 라푼젤과 똑 닮았어요! 🍳"}
    },
    "동물": {
        "강아지": {"img": TEMP_IMG, "reason": "순하고 쳐진 눈매가 사랑스러운 강아지상이에요! 🐶"},
        "고양이": {"img": TEMP_IMG, "reason": "도도하고 매력적인 눈매가 전형적인 고양이상입니다! 🐱"},
        "여우": {"img": TEMP_IMG, "reason": "가로로 긴 눈과 날렵한 턱선이 매력적인 여우상이에요! 🦊"},
        "토끼": {"img": TEMP_IMG, "reason": "하얀 피부와 귀여운 앞니가 토끼를 연상케 해요! 🐰"},
        "곰": {"img": TEMP_IMG, "reason": "둥글둥글하고 푸근한 인상이 듬직한 곰상입니다! 🐻"},
        "공룡": {"img": TEMP_IMG, "reason": "이목구비가 뚜렷하고 남성적인 매력이 넘치는 공룡상이에요! 🦖"}
    },
    "연예인 닮은꼴": {
        "아이유": {"img": TEMP_IMG, "reason": "청순하고 귀여운 이미지가 아이유와 비슷해요! 🎤"},
        "수지": {"img": TEMP_IMG, "reason": "국민 첫사랑 같은 청초한 분위기가 수지를 닮았네요! 🌸"},
        "차은우": {"img": TEMP_IMG, "reason": "조각 같은 이목구비가 얼굴 천재 차은우를 연상시켜요! ✨"},
        "송강": {"img": TEMP_IMG, "reason": "소년미와 멍뭉미가 공존하는 매력이 송강과 닮았어요! 🦋"},
        "제니": {"img": TEMP_IMG, "reason": "고급스럽고 힙한 분위기가 제니와 똑 닮았네요! 👑"},
        "박보검": {"img": TEMP_IMG, "reason": "선하고 반듯한 이미지가 박보검을 닮았어요! 🦌"}
    }
}
